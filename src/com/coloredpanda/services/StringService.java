...
public class StringService {
    private static final String STRINGS_FILE = "com.coloredpanda.res.strings";
    ...
    public static String getLanguageCodeByName(String language) {
        return supportedLanguages.stream().filter(x -> x.getName().equals(language)).map(Language::getCode).findFirst().orElse(null);
    }
